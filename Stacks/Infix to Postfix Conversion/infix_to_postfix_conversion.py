# Infix expression : When you write an arithmetic expression such as B * C. This type of notation is referred to as infix since the operator is in between the two operands that it is working on.
# Postfix expression : Like BC*, a postfix expression is a collection of operators and operands in which the operator is placed after the operands. That means, in a postfix expression the operator follows the operands.
